  ...
  return (
    <>
      ...
      <div className="flex justify-center bg-content-background h-60">
        <div className="text-3xl md:text-5xl font-merriweather mt-20 font-bold h-3">
          About Us
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row max-w-[1200px] m-auto py-10 sm:py-15 lg:py-32 items-center">
        <div className="md:pr-20 flex flex-col justify-center p-4">
          <h1 className="font-bold text-2xl md:text-4xl font-merriweather mb-6">
      ...
      <div className="bg-[#001524] text-white">
        <div className="grid grid-cols-1 md:grid-cols-4 max-w-[1240px] m-auto p-10">
          <div className="flex md:text-xl font-merriweather md:font-bold text-center md:text-left items-center justify-center mb-4 md:mb-0">
            <p>Numbers Speak For Themselves!</p>
          </div>
          <div>
            <h1 className="text-3xl lg:text-5xl font-medium mb-3 text-center">
              {count1}+
            </h1>
        ...
        <div className="flex flex-col md:flex-row lg:max-w-[1240px] m-auto overflow-hidden justify-center py-40 ">
          ...
          <div className="flex flex-col pl-10 xl:pl-32 justify-center p-5 md:w-1/2">
            <div className="flex flex-col md:flex-row mb-10 lg:mb-10 justify-center">
              ...
              <div>
                <h1 className="text-center md:text-left font-merriweather text-2xl font-semibold">
                  Certified Products
                </h1>
                <p className="text-[#333333] text lg:pt-4 text-center md:text-left">
                  Click edit button to change this text. Lorem ipsum dolor sit
                  amet
                </p>
              </div>
            ...
            <div>
              <h1 className="text-center md:text-left font-merriweather text-2xl lg:text-4xl font-semibold mb-4">
                  ...
                  <ul className="flex flex-col w-40 lg:w-64">
                    <li>
                      <FontAwesomeIcon
                        icon={faCircleCheck}
                        size="xs"
                        style={{ color: "#8bc34a", paddingRight: "10px" }}
                      />
                      Fresh fruits
                    </li>
                    <li>
                ...
                <div className="pt-10">
                  <div className="flex w-52 h-10 bg-[#6a9739] py-3 px-5 rounded-md cursor-pointer hover:bg-[#8bc34a] transition ease-linear delay-100 items-center">
                    <FontAwesomeIcon
                      ...
                      style={{ color: "#ffffff" }}
                    />
                    <button className=" text-white font-medium pl-3">
                      START SHOPPING
                    </button>
                  </div>
                </div>
